...
public class CuppytrailcockpitManager extends GeneratedCuppytrailcockpitManager
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(CuppytrailcockpitManager.class);
	...
	{
		return (CuppytrailcockpitManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CuppytrailcockpitConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		LOG.debug("init() of CuppytrailcockpitManager called, current tenant: {}", getTenant().getTenantID());
	}
