 ...
 */
package de.hybris.platform.cuppytrailcockpit.service.impl;
...
public class DefaultCuppytrailcockpitService implements CuppytrailcockpitService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCuppytrailcockpitService.class);
	...
	{
		return DefaultCuppytrailcockpitService.class.getResourceAsStream("/cuppytrailcockpit/sap-hybris-platform.png");
	}
