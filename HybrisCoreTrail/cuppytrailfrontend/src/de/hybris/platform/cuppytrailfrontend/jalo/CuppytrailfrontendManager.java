...
public class CuppytrailfrontendManager extends GeneratedCuppytrailfrontendManager
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(CuppytrailfrontendManager.class);
	...
	public void init()
	{
		LOG.debug("init() of CuppytrailfrontendManager called, current tenant: {}", getTenant().getTenantID());
	}
