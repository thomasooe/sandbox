...
public class DefaultCuppytrailfrontendService implements CuppytrailfrontendService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCuppytrailfrontendService.class);
	...
	{
		return DefaultCuppytrailfrontendService.class.getResourceAsStream("/cuppytrailfrontend/sap-hybris-platform.png");
	}
