...
public class DefaultCuppytrailhmcService implements CuppytrailhmcService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCuppytrailhmcService.class);
	...
	{
		return DefaultCuppytrailhmcService.class.getResourceAsStream("/cuppytrailhmc/sap-hybris-platform.png");
	}
