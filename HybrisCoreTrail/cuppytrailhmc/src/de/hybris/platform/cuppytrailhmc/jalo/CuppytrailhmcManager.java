...
public class CuppytrailhmcManager extends GeneratedCuppytrailhmcManager
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(CuppytrailhmcManager.class);
	...
	{
		return (CuppytrailhmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CuppytrailhmcConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		LOG.debug("init() of CuppytrailhmcManager called, current tenant: {}", getTenant().getTenantID());
	}
