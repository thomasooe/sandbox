...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performModifyTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performModifyTypes
				...
				single_createattr_Stadium_StadiumAccess();
	...
	public void single_createattr_Stadium_StadiumAccess() throws JaloBusinessException
	{
	...
	protected final void performCreateObjects( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		connectRelation(
			...
			single_setAttributeProperties_Stadium_StadiumAccess();
			...
			single_setAttributeProperties_MatchBet_matchScore();
				...
				setDefaultProperties(
					...
					null
						...
						public void single_setAttributeProperties_Stadium_StadiumAccess() throws JaloBusinessException
						{
							...
							setAttributeProperties(
								...
								"StadiumAccess",
								false, 
								em().getEnumerationValue("StadiumAccess","road"),
								"em().getEnumerationValue(\"StadiumAccess\",\"road\")",
								null,
								true,
								true,
