...
public abstract class GeneratedStadium extends GenericItem
{
	...
	/** Qualifier of the <code>Stadium.StadiumAccess</code> attribute **/
	public static final String STADIUMACCESS = "StadiumAccess";
	...
	**/
	...
	static
	{
		...
		tmp.put(STADIUMACCESS, AttributeMode.INITIAL);
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Stadium.StadiumAccess</code> attribute.
	 * @return the StadiumAccess
	 */
	public EnumerationValue getStadiumAccess(final SessionContext ctx)
	{
		return (EnumerationValue)getProperty( ctx, STADIUMACCESS);
	}
	 ...
	 * @return the StadiumAccess
	 */
	public EnumerationValue getStadiumAccess()
	{
		return getStadiumAccess( getSession().getSessionContext() );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>Stadium.StadiumAccess</code> attribute. 
	 * @param value the StadiumAccess
	 */
	public void setStadiumAccess(final SessionContext ctx, final EnumerationValue value)
	{
		setProperty(ctx, STADIUMACCESS,value);
	}
	 ...
	 * @param value the StadiumAccess
	 */
	public void setStadiumAccess(final EnumerationValue value)
	{
		setStadiumAccess( getSession().getSessionContext(), value );
	}
