...
import de.hybris.platform.cuppytrail.service.impl.DefaultCuppytrailService;
 ...
 */
@IntegrationTest
public class DefaultCuppytrailServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "cuppytrailPlatformLogo";

		// when
		final String logoUrl = cuppytrailService.getHybrisLogoUrl(logoCode);
