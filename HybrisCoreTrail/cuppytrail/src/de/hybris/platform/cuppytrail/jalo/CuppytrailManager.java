...
public class CuppytrailManager extends GeneratedCuppytrailManager
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(CuppytrailManager.class);
	...
	{
		return (CuppytrailManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CuppytrailConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		LOG.debug("init() of CuppytrailManager called, current tenant: {}", getTenant().getTenantID());
	}
