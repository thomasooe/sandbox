...
public class DefaultCuppytrailService implements CuppytrailService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCuppytrailService.class);
	...
	{
		return DefaultCuppytrailService.class.getResourceAsStream("/cuppytrail/sap-hybris-platform.png");
	}
